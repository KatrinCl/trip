            ...
            <div className="container mx-auto grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 grid-cols-1 gap-8 px-3 border-t border-solid py-16">
                <div>
                    ...
                    <p className="text-gray py-4 text-lg pb-4">
                        30 Great Peter St, WestMinister, London SWIP 283, United Kingdom
                    </p>
                ...
                <div>
                    ...
                    <ul>
                        <li className="hover:text-primary text-lg leading-10 cursor-pointer">About us</li>
                        <li className="hover:text-primary text-lg leading-10 cursor-pointer">Features</li>
                        <li className="hover:text-primary text-lg leading-10 cursor-pointer">News</li>
                        <li className="hover:text-primary text-lg leading-10 cursor-pointer">Plans</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul>
                        <li className="hover:text-primary text-lg leading-10 cursor-pointer">Why Tripco</li>
                        <li className="hover:text-primary text-lg leading-10 cursor-pointer">Partner with us</li>
                        <li className="hover:text-primary text-lg leading-10 cursor-pointer">FAQ</li>
                        <li className="hover:text-primary text-lg leading-10 cursor-pointer">Blog</li>
                    </ul>
                </div>
