...
import { FaArrowRight, FaLocationPin, FaPerson } from "react-icons/fa6"
                    ...
                    <div className="bg-white px-8 py-8 rounded-[10px] lg:absolute bottom-16 lg:w-4/5 shadow-lg">
                        <div className="lg:flex gap-4 gap-x-2">
                            ...
                            <div className="flex flex-wrap gap-x-16 w-full">
                                ...
                                <button onClick={() => setActive("Hostelry")}
                            ...
                            ${active === "Hostelry"
                                            ...
                                            : "text-light"}`}>Hostelry</button>

                                <button onClick={() => setActive("Flights")}
                                    className={`rounded-sm flex gap-x-2 items-center focus:outline-none h-14 text-base cursor-pointer bg-transparent whitespace-pre 
                            ${active === "Flights"
                                            ? "text-black border-b-2 border-solid border-black"
                                            : "text-light"}`}>Flights</button>

                                <button onClick={() => setActive("Bus & Shuttle")}
                                    className={`rounded-sm flex gap-x-2 items-center focus:outline-none h-14 text-base cursor-pointer bg-transparent whitespace-pre 
                            ${active === "Bus & Shuttle"
                                            ? "text-black border-b-2 border-solid border-black"
                                            : "text-light"}`}>Bus & Shuttle</button>

                                <button onClick={() => setActive("Cars")}
                                    className={`rounded-sm flex gap-x-2 items-center focus:outline-none h-14 text-base cursor-pointer bg-transparent whitespace-pre 
                            ${active === "Cars"
                                            ? "text-black border-b-2 border-solid border-black"
                                            : "text-light"}`}>Cars</button>
                            </div>
                            <button className="whitespace-pre flex items-center gap-2 bg-transparent outline-none border-none text-light">Last Searching
                                <FaArrowRight />
                            </button>
                        </div>
